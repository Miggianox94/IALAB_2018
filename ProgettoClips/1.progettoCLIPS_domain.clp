...
(defglobal ?*debug-print-action* = t);mettere a t oppure a nil
...
(deffacts mezzi
	...
	(posizioneMezzo (livello 0) (name Furgone1) (posizione MI))
	(posizioneMezzo (livello 0) (name Furgone2) (posizione MI))
	(posizioneMezzo (livello 0) (name Furgone3) (posizione MI))
	(posizioneMezzo (livello 0) (name Furgone4) (posizione TO))
	(posizioneMezzo (livello 0) (name Furgone5) (posizione TO))
	(posizioneMezzo (livello 0) (name Aereo1) (posizione MI))
	(posizioneMezzo (livello 0) (name Aereo2) (posizione MI))
	(posizioneMezzo (livello 0) (name Nave1) (posizione MI))
	(posizioneMezzo (livello 0) (name Nave2) (posizione TO))
)
...
;)
;
;;voglio soddisfare solo la richiesta di VERONA
;(deffacts citta
;	(citta (name TO) (produceTipo B) (produceQty 10))
;	(citta (name MI) (produceTipo C) (produceQty 5))
;	(citta (name VE) (produceTipo C) (produceQty 10) (consumaQtyB 5))
;	(citta (name GE) (produceTipo C) (produceQty 10))
;	(citta (name BO) (produceTipo B) (produceQty 10))
;	(citta (name RM) (produceTipo A) (produceQty 10))
;	(citta (name NA) (produceTipo B) (produceQty 5))
;	(citta (name BA) (produceTipo A) (produceQty 10))
;	(citta (name RC) (produceTipo A) (produceQty 20))
;	(citta (name PA) (produceTipo A) (produceQty 10))
;	(presenteInCitta (livello 0) (nomeCitta TO) (presenteInCittaQtyA 0) (presenteInCittaQtyB 10) (presenteInCittaQtyC 0))
;	(presenteInCitta (livello 0) (nomeCitta MI) (presenteInCittaQtyA 0) (presenteInCittaQtyB 0) (presenteInCittaQtyC 5))
