...
percorso(testCircuit,0,['Earls Court','Piccadilly Circus','Tottenham Court Road','Euston','Test Station']).
percorso(testCircuit2,0,['Test Station','Green Park','Oxford Circus','Final test station']).
